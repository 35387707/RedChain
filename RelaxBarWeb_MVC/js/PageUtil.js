            ...
            return (function () {
                ...
                for (; start <= end; start++) {
					if(start==args.currPage){
						totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' style='color:white;background-color:#337ab7' class='geraltTb_pager' data-go='' >" + start + "</a></li>";
					}
                    else if (start <= args.totalPage && start >= 1) {
                        totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' onclick='toPage("+start+")' class='geraltTb_pager' data-go='' >" + start + "</a></li>";
                    }
                }

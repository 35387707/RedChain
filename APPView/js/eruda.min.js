    ...
    module.exports = function() {
        ...
        var inherits = _.inherits = function(exports) {
            ...
            exports = function(Class, SuperClass) {
                if (objCreate)
                    return Class.prototype = objCreate(SuperClass.prototype);
        ...
        var Class = _.Class = function(exports) {
            ...
            function makeClass(parent, methods, statics) {
                ...
                var ctor = function() {
                    ...
                    if (has(ctor.prototype, "initialize") && !regCallSuper.test(this.initialize.toString()) && this.callSuper) {
...
function(module, exports, __webpack_require__) {
    ...
    (function(window, factory) {
        if (true) {!( __WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(5)],
...
function(module, exports, __webpack_require__) {
    var __WEBPACK_AMD_DEFINE_ARRAY__,
        __WEBPACK_AMD_DEFINE_RESULT__;
    (function(window, factory) {
        if (true) {!( __WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6)],
...
function(module, exports, __webpack_require__) {
    var __WEBPACK_AMD_DEFINE_ARRAY__,
        __WEBPACK_AMD_DEFINE_RESULT__;
    (function(window, factory) {
        if (true) {!( __WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7)],
...
function(module, exports, __webpack_require__) {
    ...
    var config = {
        create : function create(name) {
            if (!configs[name])
                configs[name] = new _Storage2.default(name);
            return configs[name]
        }
    };
...
function(module, exports, __webpack_require__) {
    ...
    var Storage = function(_util$Emitter) {
        ...
        function Storage(name) {
            ...
            if (!_this._val || !_util2.default.isObj(_this._val))
                _this._val = {};
            return _this
        }
        ...
        _createClass(DevTools, [{
            ...
            value : function _initConfig() {
                ...
                if (cfg.get("transparent"))
                    this._setTransparency(true);
                if (cfg.get("halfScreen"))
                    this._setHalfScreen(true);
    ...
    var NavBar = function(_util$Emitter) {
        ...
        _createClass(NavBar, [{
            ...
            value : function add(name) {
                this._len++;
                this._$el.append('<li class="' + name + '">' + name + "</li>").css({
                    width : this._len * 69
                })
            }
        }, {
        ...
        _createClass(Console, [{
            ...
            value : function _bindEvent() {
                ...
                $inputBtns.on("click", ".execute", function() {
                    ...
                    if (_util2.default.trim(jsInput) === "")
                        return;
                    log.input(jsInput);
            ...
            value : function _initConfig() {
                ...
                if (cfg.get("catchGlobalErr"))
                    this.catchGlobalErr();
                if (cfg.get("overrideConsole"))
        ...
        _createClass(Log, [{
            ...
            value : function _loadJs(name) {
                ...
                _util2.default.loadJs(libraries[name], function(result) {
                    if (result)
                        return _this2.log(name + " is loaded");
            ...
            value : function render() {
                if (!this._parent.active || !this._isUpdated)
                    return;
...
function(module, exports, __webpack_require__) {
    ...
    if (true) {!( __WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(28), __webpack_require__(29), __webpack_require__(30)],
...
function(module, exports, __webpack_require__) {
    ...
    (function() {
        ...
        if (true) {!( __WEBPACK_AMD_DEFINE_ARRAY__ = [],
...
function(module, exports, __webpack_require__) {
    ...
    (function() {
            ...
            function Parser() {
                ...
                this.get_tag = function(peek) {
                    ...
                    if (tag_complete.charAt(tag_complete.length - 2) === "/" || this.Utils.in_array(tag_check, this.Utils.single_token)) {
                        ...
                        tag_end = this.pos - 1;
                        this.tag_type = "SINGLE"
                    } else if (tag_check === "script" && (tag_complete.search("type") === -1 || tag_complete.search("type") > -1 && tag_complete.search(/\b(text|application)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json)/) > -1)) {
                        if (!peek) {
        ...
        if (true) {!( __WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, __webpack_require__(28), __webpack_require__(29)],
...
function(module, exports, __webpack_require__) {
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        1 : function(container, depth0, helpers, partials, data) {
            ...
            return '        <li class="eruda-' + alias4(( helper = ( helper = helpers.type || (depth0 != null ? depth0.type : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "type",
                hash : {},
                data : data
            }) : helper)) + ' eruda-log-item" data-idx="' + alias4(( helper = ( helper = helpers.index || data && data.index) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "index",
                hash : {},
                data : data
        ...
        2 : function(container, depth0, helpers, partials, data) {
            var helper;
            return '<span class="eruda-times">' + container.escapeExpression(( helper = ( helper = helpers.times || (depth0 != null ? depth0.times : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "times",
                hash : {},
                data : data
            }) : helper)) + "</span>"
        ...
        4 : function(container, depth0, helpers, partials, data) {
            var stack1,
                helper;
            return "                <pre>" + (( stack1 = ( helper = ( helper = helpers.val || (depth0 != null ? depth0.val : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "val",
                hash : {},
                data : data
            }) : helper)) != null ? stack1 : "") + "</pre>\r\n"
        },
        6 : function(container, depth0, helpers, partials, data) {
            var stack1,
                helper;
            return "                " + (( stack1 = ( helper = ( helper = helpers.val || (depth0 != null ? depth0.val : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "val",
                hash : {},
                data : data
            }) : helper)) != null ? stack1 : "") + "\r\n"
...
function(module, exports, __webpack_require__) {
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        1 : function(container, depth0, helpers, partials, data) {
            ...
            return "            <tr>\r\n                <td>" + alias1(( helper = ( helper = helpers.key || data && data.key) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "key",
                hash : {},
                data : data
    ...
    var Network = function(_Tool) {
        ...
        _createClass(Network, [{
            ...
            value : function restoreXhr() {
                var winXhrProto = window.XMLHttpRequest.prototype;
                if (this._origOpen)
                    winXhrProto.open = this._origOpen;
                if (this._origSend)
                    winXhrProto.send = this._origSend
            }
        }, {
            key : "destroy",
            value : function destroy() {
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        1 : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '            <div class="eruda-bar">\r\n                <span style="position:relative;left:' + alias4(( helper = ( helper = helpers.start || (depth0 != null ? depth0.start : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "start",
                hash : {},
                data : data
            }) : helper)) + "%;width:" + alias4(( helper = ( helper = helpers.len || (depth0 != null ? depth0.len : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "len",
                hash : {},
                data : data
                ...
                hash : {},
                data : data
            }) : helper)) + "(" + alias4(( helper = ( helper = helpers.duration || (depth0 != null ? depth0.duration : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "duration",
                hash : {},
                data : data
            }) : helper)) + "ms)</span>\r\n            </div>\r\n"
        ...
        5 : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '        <li class="eruda-request" data-id="' + alias4(( helper = ( helper = helpers.key || data && data.key) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + '">\r\n            <span>' + alias4(( helper = ( helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "name",
                hash : {},
                data : data
            }) : helper)) + "</span>\r\n            <span>" + alias4(( helper = ( helper = helpers.status || (depth0 != null ? depth0.status : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "status",
                hash : {},
                data : data
            }) : helper)) + "</span>\r\n            <span>" + alias4(( helper = ( helper = helpers.method || (depth0 != null ? depth0.method : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "method",
                hash : {},
                data : data
            }) : helper)) + "</span>\r\n            <span>" + alias4(( helper = ( helper = helpers.subType || (depth0 != null ? depth0.subType : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "subType",
                hash : {},
                data : data
            }) : helper)) + "</span>\r\n            <span>" + alias4(( helper = ( helper = helpers.size || (depth0 != null ? depth0.size : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "size",
                hash : {},
                data : data
            }) : helper)) + "</span>\r\n            <span>" + alias4(( helper = ( helper = helpers.time || (depth0 != null ? depth0.time : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "time",
                hash : {},
                data : data
            }) : helper)) + 'ms</span>\r\n            <span class="eruda-blue">' + alias4(( helper = ( helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "url",
                hash : {},
                data : data
            }) : helper)) + "</span>\r\n        </li>\r\n"
        ...
        main : function(container, depth0, helpers, partials, data) {
            ...
            return '<div class="eruda-performance-timing">\r\n    <div class="eruda-inner-wrapper">\r\n' + (( stack1 = helpers.each.call(alias1, depth0 != null ? depth0.data : depth0, {
                ...
                inverse : container.noop,
                data : data
            })) != null ? stack1 : "") + '        </tbody>\r\n    </table>\r\n</div>\r\n\r\n<ul class="eruda-requests">\r\n' + (( stack1 = helpers.each.call(alias1, depth0 != null ? depth0.requests : depth0, {
                name : "each",
                hash : {},
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        ...
        2 : function(container, depth0, helpers, partials, data) {
            var stack1,
                ...
                alias2 = helpers.helperMissing,
                alias3 = "function";
            return '            <li class="eruda-child" data-idx="' + container.escapeExpression(( helper = ( helper = helpers.idx || (depth0 != null ? depth0.idx : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "idx",
                hash : {},
                data : data
            }) : helper)) + '">' + (( stack1 = ( helper = ( helper = helpers.text || (depth0 != null ? depth0.text : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "text",
                hash : {},
                data : data
        ...
        5 : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return "                    <tr>\r\n                        <td>" + alias4(( helper = ( helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "name",
                hash : {},
                data : data
            }) : helper)) + "</td>\r\n                        <td>" + alias4(( helper = ( helper = helpers.value || (depth0 != null ? depth0.value : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "value",
                hash : {},
                data : data
            }) : helper)) + "</td>\r\n                    </tr>\r\n"
        ...
        10 : function(container, depth0, helpers, partials, data) {
            var helper,
                alias1 = container.escapeExpression;
            return '                    <tr>\r\n                        <td class="eruda-key">' + alias1(( helper = ( helper = helpers.key || data && data.key) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + "</td>\r\n                        <td>" + alias1(container.lambda(depth0, depth0)) + "</td>\r\n                    </tr>\r\n"
        ...
        13 : function(container, depth0, helpers, partials, data) {
            var stack1,
                helper,
                alias1 = depth0 != null ? depth0 : {};
            return '                <div class="eruda-style-rules">\r\n                    <div>' + container.escapeExpression(( helper = ( helper = helpers.selectorText || (depth0 != null ? depth0.selectorText : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(alias1, {
                name : "selectorText",
                hash : {},
                data : data
        ...
        14 : function(container, depth0, helpers, partials, data) {
            var helper,
                alias1 = container.escapeExpression;
            return '                        <div class="eruda-rule">\r\n                            <span>' + alias1(( helper = ( helper = helpers.key || data && data.key) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + "</span>: " + alias1(container.lambda(depth0, depth0)) + ";\r\n                        </div>\r\n"
        },
        compiler : [7, ">= 4.0.0"],
        main : function(container, depth0, helpers, partials, data) {
            var stack1,
            ...
            return '<div class="eruda-breadcrumb">\r\n    ' + (( stack1 = ( helper = ( helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(alias1, {
                ...
                inverse : container.noop,
                data : data
            })) != null ? stack1 : "") + (( stack1 = helpers["if"].call(alias1, depth0 != null ? depth0.styles : depth0, {
                name : "if",
                hash : {},
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        1 : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '    <div class="eruda-section">\r\n        <h2 class="eruda-name">' + alias4(( helper = ( helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "name",
                hash : {},
                data : data
                ...
                hash : {},
                data : data
            }) : helper)) + '\r\n        </div>\r\n        <div class="eruda-btn run" data-idx="' + alias4(( helper = ( helper = helpers.index || data && data.index) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "index",
                hash : {},
                data : data
            }) : helper)) + '" ontouchstart>Run</div>\r\n    </div>\r\n'
        },
        compiler : [7, ">= 4.0.0"],
        main : function(container, depth0, helpers, partials, data) {
            var stack1;
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        ...
        2 : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '                    <tr>\r\n                        <td class="eruda-key">' + alias4(( helper = ( helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + "</td>\r\n                        <td>" + alias4(( helper = ( helper = helpers.val || (depth0 != null ? depth0.val : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "val",
                hash : {},
                data : data
            }) : helper)) + '</td>\r\n                        <td class="eruda-control">\r\n                            <span class="eruda-icon-bin delete-local-storage" data-key="' + alias4(( helper = ( helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + '"></span>\r\n                        </td>\r\n                    </tr>\r\n'
        ...
        7 : function(container, depth0, helpers, partials, data) {
            ...
            return '                    <tr>\r\n                        <td class="eruda-key">' + alias4(( helper = ( helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                ...
                hash : {},
                data : data
            }) : helper)) + '</td>\r\n                        <td class="eruda-control">\r\n                            <span class="eruda-icon-bin delete-cookie" data-key="' + alias4(( helper = ( helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + '"></span>\r\n                        </td>\r\n                    </tr>\r\n'
        ...
        main : function(container, depth0, helpers, partials, data) {
            var stack1,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '<div class="eruda-section">\r\n    <h2 class="eruda-title ' + alias4(( helper = ( helper = helpers.localStoreState || (depth0 != null ? depth0.localStoreState : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "localStoreState",
                hash : {},
                data : data
                ...
                data : data
            })) != null ? stack1 : "") + '        </tbody>\r\n    </table>\r\n</div>\r\n<div class="eruda-section">\r\n    <h2 class="eruda-title ' + alias4(( helper = ( helper = helpers.cookieState || (depth0 != null ? depth0.cookieState : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "cookieState",
                hash : {},
                data : data
                ...
                inverse : container.program(4, data, 0),
                data : data
            })) != null ? stack1 : "") + '        </tbody>\r\n    </table>\r\n</div>\r\n<div class="eruda-section">\r\n    <h2 class="eruda-title ' + alias4(( helper = ( helper = helpers.scriptState || (depth0 != null ? depth0.scriptState : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "scriptState",
                hash : {},
                data : data
                ...
                data : data
            })) != null ? stack1 : "") + '    </ul>\r\n</div>\r\n<div class="eruda-section">\r\n    <h2 class="eruda-title ' + alias4(( helper = ( helper = helpers.stylesheetState || (depth0 != null ? depth0.stylesheetState : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                ...
                inverse : container.program(12, data, 0),
                data : data
            })) != null ? stack1 : "") + '    </ul>\r\n</div>\r\n<div class="eruda-section">\r\n    <h2 class="eruda-title ' + alias4(( helper = ( helper = helpers.imageState || (depth0 != null ? depth0.imageState : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "imageState",
                hash : {},
                data : data
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        1 : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '        <li>\r\n            <h2 class="eruda-title">' + alias4(( helper = ( helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "name",
                hash : {},
                data : data
            }) : helper)) + '</h2>\r\n            <p class="eruda-content">' + alias4(( helper = ( helper = helpers.val || (depth0 != null ? depth0.val : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "val",
                hash : {},
                data : data
            }) : helper)) + "</p>\r\n        </li>\r\n"
            ...
            if (easy_detect || isSVG) {
                ...
                blockedDetect = function() {
                    ...
                    if (!docElement.contains(body)) {
                        ...
                        embed.type = "application/x-shockwave-flash";
                        body.appendChild(embed);
                        return setTimeout(blockedDetect, 1e3)
                    }
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        1 : function(container, depth0, helpers, partials, data) {
            var stack1,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '        <li>\r\n            <a href="http://caniuse.com/#search=' + alias4(( helper = ( helper = helpers.key || data && data.key) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "key",
                hash : {},
                data : data
            }) : helper)) + '" target="_blank" class="eruda-inner-wrapper ' + (( stack1 = helpers["if"].call(alias1, depth0, {
                name : "if",
                hash : {},
                fn : container.program(2, data, 0),
                inverse : container.noop,
...
function(module, exports, __webpack_require__) {
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        ...
        main : function(container, depth0, helpers, partials, data) {
            var stack1,
                helper;
            return '<pre class="eruda-code">' + (( stack1 = ( helper = ( helper = helpers.code || (depth0 != null ? depth0.code : depth0)) != null ? helper : helpers.helperMissing, typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {}, {
                name : "code",
                hash : {},
                data : data
            }) : helper)) != null ? stack1 : "") + "</pre>"
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        ...
        main : function(container, depth0, helpers, partials, data) {
            var helper,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '<div class="eruda-image">\r\n    <div class="eruda-img-container">\r\n        <img src="' + alias4(( helper = ( helper = helpers.src || (depth0 != null ? depth0.src : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "src",
                hash : {},
                data : data
            }) : helper)) + '">\r\n    </div>\r\n    <div class="eruda-img-info">' + alias4(( helper = ( helper = helpers.width || (depth0 != null ? depth0.width : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "width",
                hash : {},
                data : data
            }) : helper)) + "px * " + alias4(( helper = ( helper = helpers.height || (depth0 != null ? depth0.height : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "height",
                hash : {},
                data : data
            }) : helper)) + "px</div>\r\n</div>"
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        ...
        main : function(container, depth0, helpers, partials, data) {
            var stack1,
                ...
                alias3 = "function",
                alias4 = container.escapeExpression;
            return '<div class="eruda-http">\r\n    <div class="eruda-breadcrumb">' + alias4(( helper = ( helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "url",
                hash : {},
                data : data
            }) : helper)) + '</div>\r\n    <div class="eruda-section">\r\n        <h2>Response Headers</h2>\r\n        <table class="eruda-headers">\r\n            <tbody>\r\n' + (( stack1 = helpers.each.call(alias1, depth0 != null ? depth0.resHeaders : depth0, {
                name : "each",
                hash : {},
                fn : container.program(1, data, 0),
                inverse : container.noop,
                data : data
            })) != null ? stack1 : "") + '            </tbody>\r\n        </table>\r\n    </div>\r\n    <pre class="eruda-response">' + alias4(( helper = ( helper = helpers.resTxt || (depth0 != null ? depth0.resTxt : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "resTxt",
                hash : {},
                data : data
            }) : helper)) + "</pre>\r\n</div>"
    ...
    module.exports = (Handlebars["default"] || Handlebars).template({
        ...
        main : function(container, depth0, helpers, partials, data) {
            ...
            return '<div class="eruda-switch">\r\n    ' + alias4(( helper = ( helper = helpers.desc || (depth0 != null ? depth0.desc : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                ...
                hash : {},
                data : data
            }) : helper)) + '\r\n    <label class="eruda-checkbox">\r\n        <input type="checkbox" class="eruda-input" data-idx="' + alias4(( helper = ( helper = helpers.idx || (depth0 != null ? depth0.idx : depth0)) != null ? helper : alias2, typeof helper === alias3 ? helper.call(alias1, {
                name : "idx",
                hash : {},
                data : data
            }) : helper)) + '" ' + (( stack1 = helpers["if"].call(alias1, depth0 != null ? depth0.val : depth0, {
                name : "if",
                hash : {},
                fn : container.program(1, data, 0),
                inverse : container.noop,

...
//#endif
                ...
                new LogsBLL().InsertLog(Guid.Empty,toxml, Common.enLogType.Services);
                ...
                {
                    new LogsBLL().InsertLog(Guid.Empty, result, Common.enLogType.Services);
                    return "";
                }
            }
            catch (Exception ex)
            {
                new LogsBLL().InsertLog(Guid.Empty, ex, Common.enLogType.Services);
                return "";
            }
        }
        ...
        public string GetPayResultNumber(string content, out decimal fee)
        {
            ...
            try
            {
                new LogsBLL().InsertLog(Guid.Empty, content, Common.enLogType.Services);
                WX_Services.WxPayData data = new WX_Services.WxPayData(WX_Services.euEncryptType.MD5);
